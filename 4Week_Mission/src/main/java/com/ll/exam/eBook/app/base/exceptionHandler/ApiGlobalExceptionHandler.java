package com.ll.exam.eBook.app.base.exceptionHandler;
...
public class ApiGlobalExceptionHandler {
    ...
    public ResponseEntity<RsData<String>> errorHandler(MethodArgumentNotValidException exception) {
        ...
        return Util.sp.responseEntityOf(RsData.of("F-MethodArgumentNotValidException", msg, data));
    }
    ...
    public ResponseEntity<RsData<String>> errorHandler(RuntimeException exception) {
        ...
        return Util.sp.responseEntityOf(RsData.of("F-RuntimeException", msg, data));
    }
}
